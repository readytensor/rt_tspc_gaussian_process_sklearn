# Gaussian Process Time Step Classifier in Scikit-learn

Gaussian Process Time Step Classification Model in Scikit-learn as per Ready Tensor specifications.
...
- A **Gaussian Process Time Step Classification** model built using **Scikit-learn**
